...
![CI](https://shieldcn.dev/github/ci/lava-sh/toml-rs.svg?variant=outline&animate=pulse&font=geist-mono&mode=dark)
![Last Commit](https://shieldcn.dev/github/last-commit/lava-sh/toml-rs.svg?variant=outline&font=geist-mono)
