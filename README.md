...
![CI](https://shieldcn.dev/github/ci/lava-sh/toml-rs.svg?variant=outline&animate=pulse&font=geist-mono&size=xs&mode=light)
![Last Commit](https://shieldcn.dev/github/last-commit/lava-sh/toml-rs.svg?variant=outline&font=geist-mono&size=xs&mode=light)
[![License](https://shieldcn.dev/github/lava-sh/toml-rs/license.svg?variant=outline&font=geist-mono&size=xs&mode=light)](https://github.com/lava-sh/toml-rs/blob/main/UNLICENSE)
[![Monthly downloads](https://shieldcn.dev/pypi/dm/toml_rs.svg?variant=outline&font=geist-mono&size=xs&mode=light)](https://pypi.org/project/toml_rs)
[![Python version](https://shieldcn.dev/pypi/python/toml_rs.svg?variant=outline&font=geist-mono&size=xs&mode=light)](https://pypi.org/project/toml_rs)
